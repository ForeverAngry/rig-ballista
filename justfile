...
release-preview:
    ...
    git add .
    git commit -q -m "feat: prepare rig-ballista release preview"
    release-plz update --repo-url https://github.com/ForeverAngry/rig-ballista

release-pr:
    release-plz release-pr

next-version:
    @just release-preview 2>&1 | grep -E "(next version|already up-to-date|rig-ballista)" || true
